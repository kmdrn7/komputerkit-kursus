...
@section('content')
	...
	<div class="row no-margin-bottom">
		<div class="login-container valign-wrapper bd">
			<div class="llc valign-wrapper hide-on-med-and-down">
				<div class="llc-c card-panel z-depth-4">
					<img src="{{ asset('img/logo/favicon.png') }}" alt="">
					<span><span>Kursus</span> KomputerKit.com</span>
				</div>
			</div>
			<div class="lrc">
				<div class="card-panel fh no-margin-bottom no-margin-top" style="overflow-y: auto">
					<div class="row">
						<div class="col s12">
